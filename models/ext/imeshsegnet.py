...
class iMeshSegNet(nn.Module):
    ...
    def forward(self, x, kg_6, kg_12):
        ...
        glm_1 = F.leaky_relu(self.glm1_bn2_1(self.glm1_conv2_1(kg_12)), negative_slope=0.2)
        glm_1 = F.leaky_relu(self.glm1_bn2_2(self.glm1_conv2_2(glm_1)), negative_slope=0.2)
        ...
        glm_2_1 = F.leaky_relu(self.glm2_bn2_1(self.glm2_conv2_1(kg_12)), negative_slope=0.2)
        glm_2_1 = F.leaky_relu(self.glm2_bn2_2(self.glm2_conv2_2(glm_2_1)), negative_slope=0.2)
        glm_2_1 = glm_2_1.max(dim=-1, keepdim=False)[0]
        glm_2_2 = F.leaky_relu(self.glm2_bn3_1(self.glm2_conv3_1(kg_6)), negative_slope=0.2)
        glm_2_2 = F.leaky_relu(self.glm2_bn3_2(self.glm2_conv3_2(glm_2_2)), negative_slope=0.2)
