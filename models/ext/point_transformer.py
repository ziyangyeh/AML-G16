...
class PointTransformerSeg(nn.Module):
    def __init__(self, block, blocks, num_channels=6, num_classes=17):
        super().__init__()
        self.in_channels = num_channels
        self.in_planes, planes = num_channels, [32, 64, 128, 256, 512]
    ...
    def forward(self, x):
        ...
        x = self.cls(x1)
        x = rearrange(x, "(b n) c -> b n c", b=feat_shape["b"])
        return x
